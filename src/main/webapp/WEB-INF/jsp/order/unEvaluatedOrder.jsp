    ...
    <div class="orderbar">
      	...
      	<ul class="cart-group clearfix">
      	  <c:forEach var="od" items="${odList }">
              <li class="ware-item">
                <div class="ware-img"><a href="查看订单.html"><img src="${pageContext.request.contextPath}/resource/${od.productMasterPic}" alt="水果" /></a></div>
                <div class="ware-info">
                   ...
                   <div class="cart-bar">
                     <a class="c-btn" href="${pageContext.request.contextPath}/">评价</a>
                     <div class="ware-title"> 
                       <span class="h2">${od.productDesc }</span>
                     </div>
