...
<script type="text/javascript">
	...
	function insertReview(){
		...
		$.post{
			...
			function(data){
				if(data["success"]){
					window.location.href="${pageContext.request.contextPath}/product/toReview";
				}
			},
			"json"
		}
...
<section class="bgGrey mb110">
    ...
    <div class="orderbar">
     ...
     <div class="clearfix">
      <div class="ware-item">
                <div class="ware-img"><a href="详情.html"><img src="${pageContext.request.contextPath}/resource/${product.productMasterPic}" alt="水果" /></a></div>
                <div class="ware-info">
